...
final class JournalLineTest extends TestCase
{
    ...
    {
        $line = Line::create('cash', 100.00, Side::Debit);
    ...
    {
        $line = Line::create('sales', 100.00, Side::Credit);
    ...
    public function test_cannot_create_line_with_zero_amount(): void
    {
        ...
        Line::create('cash', 0.00, Side::Debit);
    }
    ...
    public function test_cannot_create_line_with_negative_amount(): void
    {
        ...
        Line::create('cash', -100.00, Side::Debit);
    }
    ...
    public function test_cannot_create_line_with_more_than_two_decimal_places(): void
    {
        ...
        Line::create('cash', 100.123, Side::Debit);
    }

    public function test_can_create_line_with_two_decimal_places(): void
    {
        $line = Line::create('cash', 100.99, Side::Debit);
    ...
    {
        $line1 = Line::create('cash', 100.00, Side::Debit);
        $line2 = Line::create('cash', 100.00, Side::Debit);
    ...
    {
        $line1 = Line::create('cash', 100.00, Side::Debit);
        $line2 = Line::create('bank', 100.00, Side::Debit);
    ...
    {
        $line1 = Line::create('cash', 100.00, Side::Debit);
        $line2 = Line::create('cash', 200.00, Side::Debit);
    ...
    {
        $line1 = Line::create('cash', 100.00, Side::Debit);
        $line2 = Line::create('cash', 100.00, Side::Credit);
    ...
    {
        $line = Line::create('cash', 100.50, Side::Debit);
